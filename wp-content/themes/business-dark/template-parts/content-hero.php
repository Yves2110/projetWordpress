...
?>  
<!-- ======= Hero Section ======= -->
<section class="home5-hero-sec busi-dark-banner" style="background-image:url(<?php if($techup_banner_image) { echo $techup_banner_image; } else { echo get_header_image(); } ?>)">
